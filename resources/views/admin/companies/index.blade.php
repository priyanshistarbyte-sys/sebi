<x-layouts.admin title="Companies" :breadcrumbs="[
    ['label'=>'Dashboard','url'=>route('admin.dashboard')],
    ['label'=>'Companies']
]">
    <div class="flex items-center justify-between mb-4">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Companies</h1>
        <a href="{{ route('admin.companies.create') }}" class="px-3 py-2 bg-blue-600 dark:bg-blue-700 text-white rounded hover:bg-blue-700 dark:hover:bg-blue-800 transition-colors duration-200">
            + Add Company
        </a>
    </div>
    ...
    <div class="overflow-x-auto rounded border border-gray-200 dark:border-gray-700">
        <table class="w-full text-sm">
            ...
            <tr class="text-left">
                <th class="p-2 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100">#</th>
                <th class="p-2 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100">Name</th>
                <th class="p-2 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100">Currency</th>
            ...
            @forelse($companies as $c)
                <tr class="odd:bg-white dark:odd:bg-gray-900 even:bg-gray-50 dark:even:bg-gray-800">
                    <td class="p-2 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100">{{ $c->id }}</td>
                    <td class="p-2 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100">{{ $c->name }}</td>
                    <td class="p-2 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100">{{ $c->currency_symbol }}</td>
                    <td class="p-2 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 flex items-center justify-center">
                        <a class="text-blue-600 dark:text-blue-400 underline hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-200" href="{{ route('admin.companies.edit',$c) }}">
                        ...
                        <form action="{{ route('admin.companies.destroy',$c) }}" method="POST" class="inline"
            ...
            @empty
                <tr><td colspan="4" class="p-4 text-center text-gray-500 dark:text-gray-400 odd:bg-white dark:odd:bg-gray-900 even:bg-gray-50 dark:even:bg-gray-800">No companies found.</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
